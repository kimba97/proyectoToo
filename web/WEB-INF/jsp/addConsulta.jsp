...
<html>
    ...
    <body>
        <div class="container">
            <ol class="breadcrumb">
                <li><a href="<c:url value="signosVitales.htm"/>">Signos Vitales<a/>
                <li class="active">Consulta</li>
            </ol>
            <div class="panel panel-primary">
                <div class="panel-heading">Formulario para agregar nuevas Consultas</div>
                <div class="panel-body">
                    <form:form method="post" commandName="consultas">
                        <h1>Complete los siguientes campos</h1>
                        <form:errors path="*" element="div" cssClass="alert alert-danger"/>
                        <p>
                            <form:label path="cod_Cons">Codigo de Consulta: </form:label>
                        ...
                        <p>
                            <form:label path="doctor_Cons">Medico Encargado: </form:label>
                            <form:input path="doctor_Cons" cssClass="form-control"/>
                        </p>
